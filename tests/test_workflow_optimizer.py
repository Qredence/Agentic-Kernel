...
def sample_workflow():
    ...
    step1 = WorkflowStep(task=task1, dependencies=[], parallel=False)
    steps.append(step1)
    ...
    step2 = WorkflowStep(task=task2, dependencies=["fetch_data"], parallel=False)
    steps.append(step2)
    ...
    step3 = WorkflowStep(task=task3, dependencies=["process_data"], parallel=False)
    steps.append(step3)
    ...
    step4 = WorkflowStep(task=task4, dependencies=["generate_report"], parallel=False)
    steps.append(step4)
            ...
            "step_results": {
                "fetch_data": {
                    ...
                    "metrics": {
                        ...
                        "agent_type": "web_surfer",
                        "agent_id": "agent1",
                        "resource_usage": {"memory": 120, "cpu": 30, "network": 500},
                    },
                },
                "process_data": {
                    "status": "success",
                    "metrics": {
                        ...
                        "agent_type": "data_processor",
                        "agent_id": "agent2",
                        "resource_usage": {"memory": 2200, "cpu": 90, "disk": 150},
                    },
                },
                "generate_report": {
                    "status": "success",
                    "metrics": {
                        ...
                        "agent_type": "report_generator",
                        "agent_id": "agent3",
                        "resource_usage": {"memory": 450, "cpu": 60, "disk": 200},
                    },
                },
                "send_notification": {
                    "status": "success",
                    "metrics": {
                        ...
                        "agent_type": "notifier",
                        "agent_id": "agent4",
                        "resource_usage": {"memory": 80, "cpu": 10, "network": 50},
                    },
                },
            },
            "metrics": {
            ...
            "step_results": {
                "fetch_data": {
                    ...
                    "metrics": {
                        ...
                        "agent_type": "web_surfer",
                        "agent_id": "agent1",
                        "resource_usage": {"memory": 125, "cpu": 32, "network": 520},
                    },
                },
                "process_data": {
                    "status": "success",
                    "metrics": {
                        ...
                        "agent_id": "agent5",
                        "resource_usage": {"memory": 1800, "cpu": 70, "disk": 120},
                    },
                },
                "generate_report": {
                    "status": "failed",
                    ...
                    "metrics": {
                        ...
                        "agent_type": "report_generator",
                        "agent_id": "agent3",
                        "resource_usage": {"memory": 380, "cpu": 40, "disk": 50},
                    },
                },
                "send_notification": {
                    "status": "skipped",
            ...
            "step_results": {
                "fetch_data": {
                    ...
                    "metrics": {
                        ...
                        "agent_id": "agent6",
                        "resource_usage": {"memory": 110, "cpu": 25, "network": 480},
                    },
                },
                "process_data": {
                    "status": "success",
                    "metrics": {
                        ...
                        "agent_type": "data_processor",
                        "agent_id": "agent2",
                        "resource_usage": {"memory": 2100, "cpu": 85, "disk": 140},
                    },
                },
                "generate_report": {
                    "status": "success",
                    "metrics": {
                        ...
                        "agent_type": "report_generator",
                        "agent_id": "agent3",
                        "resource_usage": {"memory": 430, "cpu": 55, "disk": 180},
                    },
                },
                "send_notification": {
                    "status": "success",
                    "metrics": {
                        ...
                        "agent_type": "notifier",
                        "agent_id": "agent4",
                        "resource_usage": {"memory": 75, "cpu": 9, "network": 45},
                    },
                },
            },
            "metrics": {
    ...
    return [
        {
            ...
            "metrics": {"execution_time": 900, "success_rate": 1.0},
            "step_results": {
                "process_data": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "data_processor",
                        "execution_time": 300,
                        "resource_usage": {"memory": 500, "cpu": 40},
                    },
                },
                "analyze_data": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "data_analyzer",
                        "execution_time": 350,
                        "resource_usage": {"memory": 800, "cpu": 70},
                    },
                },
                "generate_report": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "report_generator",
                        "execution_time": 200,
                        "resource_usage": {"memory": 300, "cpu": 30},
                    },
                },
                "send_notification": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "notifier",
                        "execution_time": 50,
                        "resource_usage": {"memory": 100, "cpu": 10},
                    },
                },
            },
        },
        {
            ...
            "metrics": {"execution_time": 840, "success_rate": 1.0},
            "step_results": {
                "process_data": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "data_processor",
                        "execution_time": 290,
                        "resource_usage": {"memory": 520, "cpu": 45},
                    },
                },
                "analyze_data": {
                    "status": "success",
                    "metrics": {
                        ...
                        "execution_time": 320,
                        "resource_usage": {"memory": 750, "cpu": 65},
                    },
                },
                "generate_report": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "report_generator",
                        "execution_time": 180,
                        "resource_usage": {"memory": 320, "cpu": 35},
                    },
                },
                "send_notification": {
                    "status": "success",
        ...
        },
        {
            ...
            "metrics": {"execution_time": 810, "success_rate": 1.0},
            "step_results": {
                "process_data": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "data_processor",
                        "execution_time": 280,
                        "resource_usage": {"memory": 510, "cpu": 42},
                    },
                },
                "analyze_data": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "improved_analyzer",
                        "execution_time": 300,
                        "resource_usage": {"memory": 730, "cpu": 60},
                    },
                },
                "generate_report": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "report_generator",
                        "execution_time": 190,
                        "resource_usage": {"memory": 310, "cpu": 32},
                    },
                },
                "send_notification": {
                    "status": "success",
                    "metrics": {
                        "agent_type": "notifier",
                        "execution_time": 40,
                        "resource_usage": {"memory": 90, "cpu": 8},
                    },
                },
            },
        },
...
async def test_workflow_optimizer_initialization():
    ...
    assert any(
        isinstance(strategy, ParallelizationOptimizer)
        for strategy in optimizer.strategies
    )
    assert any(
        isinstance(strategy, AgentSelectionOptimizer)
        for strategy in optimizer.strategies
    )
    assert any(
        isinstance(strategy, ResourceOptimizer) for strategy in optimizer.strategies
    )
...
async def test_parallelization_optimizer(workflow_steps, execution_history):
    ...
    optimized_workflow, results = await optimizer.optimize(
        workflow_steps, execution_history
    )
...
async def test_agent_selection_optimizer(workflow_steps, execution_history):
    ...
    if changes:
        ...
        for change in changes:
            ...
            step = next(
                (s for s in optimized_workflow if s.task.name == change["step"]), None
            )
