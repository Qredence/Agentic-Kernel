...
class A2AServer:
        ...
        self.app = starlette.applications.Starlette(
            ...
            routes=[
                starlette.routing.Route(
                    "/.well-known/agent.json", self._handle_agent_card, methods=["GET"]
                ),
    ...
    def _setup_default_methods(self):
        ...
        self.registry.register(
            "tasks/sendSubscribe", self.handle_tasks_send_subscribe, streaming=True
        )
        self.registry.register("tasks/get", self.handle_tasks_get)
        self.registry.register("tasks/cancel", self.handle_tasks_cancel)
        self.registry.register(
            "tasks/pushNotification/set", self.handle_tasks_push_notification_set
        )
        self.registry.register(
            "tasks/pushNotification/get", self.handle_tasks_push_notification_get
        )
        self.registry.register(
            "tasks/resubscribe", self.handle_tasks_resubscribe, streaming=True
        )
    ...
    async def handle_tasks_push_notification_set(
    ...
    async def handle_tasks_push_notification_get(
        self, params: dict[str, Any]
    ) -> dict[str, Any]:
