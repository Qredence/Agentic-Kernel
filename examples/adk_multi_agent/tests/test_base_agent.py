...
def test_agent_initialization():
    ...
    agent = Agent(name="test_agent", model="test_model", instruction="test instruction")
...
def test_agent_add_tool():
    ...
    tool = FunctionTool(
        name="test_tool", description="test description", function=test_function
    )
...
def test_session_service():
    ...
    session = service.create_session(
        state={"test": "state"}, app_name="test_app", user_id="test_user"
    )
